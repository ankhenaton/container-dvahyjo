...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-dvahyjo.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-dvahyjo.containers.anotherwebservice.com/
...
```
git clone git@github.com:ankhenaton/container-dvahyjo.git
cd container-dvahyjo
```
...
```
docker attach container-dvahyjo
```
